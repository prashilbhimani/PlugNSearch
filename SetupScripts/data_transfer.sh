...
sudo cp -r $download_dir ~/Downloads
...
gcloud compute --project "datacenterscaleproject" ssh --zone "us-east1-b" "torrentgetter" --command "ls"
gcloud compute  scp --zone "us-east1-b" torrent/torrent.sh torrentgetter:~/
